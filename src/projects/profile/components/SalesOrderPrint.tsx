      ...
      <div className="order-container">
          ...
          <div className="top-info">
              ...
              <div className="order-details">
                  ...
                  <div className="info-row"><span className="info-label">PO No:</span><span className="info-value">{order.customerPONo}</span></div>
                  <div className="info-row"><span className="info-label">PO Date:</span><span className="info-value">{order.customerPODate}</span></div>
              </div>
          </div>
