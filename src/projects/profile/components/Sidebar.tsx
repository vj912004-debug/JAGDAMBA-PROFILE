    ...
    <aside className="hidden md:flex flex-col w-64 bg-white border-r border-slate-200 h-screen sticky top-0 shadow-sm z-50">
      ...
      <div className="p-6 border-b border-slate-50">
        <button 
          ...
          className="w-full mb-6 flex items-center justify-center gap-2 px-4 py-2.5 rounded-2xl text-[11px] font-black text-slate-500 hover:bg-blue-50 hover:text-blue-600 transition-all border border-slate-100 hover:border-blue-100 shadow-xs uppercase tracking-wider"
        >
