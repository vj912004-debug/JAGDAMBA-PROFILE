        ...
        <div class="border-inner-dl">
            ...
            <div class="header-container-dl">
                <div class="logo-area-dl">
                    <img src="${LOGO_BASE64}" alt="Jagdamba Profile Logo" class="company-logo-dl" onerror="this.style.display='none'; if (this.nextElementSibling) this.nextElementSibling.style.display='block';" />
        ...
        <div class="inner-border-orig" style="position: relative;">
            ...
            <div class="header-orig">
                <div class="logo-container-orig">
                    <img src="${LOGO_BASE64}" alt="Jagdamba Profile Logo" class="company-logo-orig" onerror="this.style.display='none';">
