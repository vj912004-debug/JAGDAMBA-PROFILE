            ...
            <tbody className="divide-y divide-slate-50 dark:divide-slate-850 text-slate-700 dark:text-slate-300">
              {filteredParties.length === 0 ? (
                ...
                filteredParties.map(p => {
                  ...
                  return (
                    <tr key={p.id} className="hover:bg-slate-50 dark:bg-slate-800/50/55 dark:hover:bg-slate-900/30 transition-all">
                      {/* Name & Branch */}
                      ...
                      <td className="px-6 py-5 text-right">
                        <div className="flex items-center justify-end gap-2">
                          <button
                            ...
                            className="p-1.5 text-slate-600 dark:text-slate-400 bg-slate-50 dark:bg-slate-800/50 hover:bg-slate-100 dark:bg-slate-950 dark:hover:bg-slate-850 border border-slate-100 dark:border-slate-850 hover:text-blue-600 dark:hover:text-blue-450 rounded-lg transition-all"
                          >
                          ...
                          <button
                            ...
                            className="p-1.5 text-slate-600 dark:text-slate-400 bg-slate-50 dark:bg-slate-800/50 hover:bg-slate-100 dark:bg-slate-950 dark:hover:bg-slate-850 border border-slate-100 dark:border-slate-850 hover:text-red-600 dark:hover:text-red-450 rounded-lg transition-all"
                          >
            ...
            <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto p-6 space-y-5 text-left">
              ...
              <div className="pt-6 border-t border-slate-100 dark:border-slate-900 flex items-center justify-end gap-3 bg-white dark:bg-slate-950">
                <button
                  type="button"
                  onClick={() => setIsDrawerOpen(false)}
                  className="px-4 py-2 text-xs font-bold text-slate-500 hover:bg-slate-100 dark:bg-slate-800 dark:hover:bg-slate-900 rounded-lg transition-all"
                >
                  Cancel
                </button>
                <button
