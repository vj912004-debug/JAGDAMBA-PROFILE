...
with client.open_sftp() as sftp:
    with sftp.file('/etc/nginx/sites-available/jagdambaprofile.tech', 'w') as f:
        f.write(new_config)

commands = [
    "ln -sf /etc/nginx/sites-available/jagdambaprofile.tech /etc/nginx/sites-enabled/",
    "nginx -t && systemctl restart nginx",
    "cd /root/JAGDAMBA-PROFILE && git pull origin master && npm run build"
]
