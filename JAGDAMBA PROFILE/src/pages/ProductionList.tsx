...
export const ProductionList: React.FC = () => {
  ...
  const handleStatusChange = async (orderId: string, itemId: string, newStatus: 'Pending' | 'In Progress' | 'Completed') => {
    await updateItemStatus(orderId, itemId, newStatus);
    toast.success(`Item status updated to ${newStatus}`);
    // If modal is open, update the selected order to reflect changes
